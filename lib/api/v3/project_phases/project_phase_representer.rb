...
module API
  module V3
    module ProjectPhases
      ...
      # FIXME: This name is automatically generated by the ParamsToQueryService - this alias here is just a quick way
      # to make this class discoverable. Consider fixing the ParamsToQueryService to use the correct name instead.
