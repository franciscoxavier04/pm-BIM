...
RSpec.describe "Work package calendars", :js do
  ...
  it "navigates to today, allows filtering, switching the view and retrains the state" do
    ...
    expect(page).to have_test_selector("op-breadcrumb-item", text: "Calendars")
    expect(page).to have_css(".op-breadcrumb-item.active", text: "Unnamed calendar", aria: { current: "page" })
