...
class Queries::Projects::Filters::AncestorOrSelfFilter < Queries::Projects::Filters::Base
  ...
  def ancestor_condition
    projects_table[:lft]
      .gteq(projects_ancestor_table[:lft])
      .and(projects_table[:rgt].lteq(projects_ancestor_table[:rgt]))
  end
