...
class PortfolioManagements::IndexPageHeaderComponent < ApplicationComponent
  ...
  def breadcrumb_items
    [
      ...
      { href: url_for({ controller: "portfolio_managements", action: :show, project_id: @project }),
        text: I18n.t(:label_portfolio_management) },
