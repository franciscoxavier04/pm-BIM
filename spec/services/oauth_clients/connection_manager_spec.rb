  ...
  describe "#code_to_token", :webmock do
    ...
    context "with happy path" do
      before do
        ...
        stub_request(:get, File.join(host, "/ocs/v1.php/cloud/user")).with(
          headers: {
            "Authorization" => "Bearer yjTDZ...RYvRH",
            "Ocs-Apirequest" => "true"
          }
          ...
          <ocs>
           ...
           <data>
            ...
            <id>admin</id>
            <lastLogin>1738833138000</lastLogin>
            <backend>Database</backend>
            <subadmin/>
            <quota>
             <free>447793922048</free>
             <used>37754592</used>
             <total>447831676640</total>
